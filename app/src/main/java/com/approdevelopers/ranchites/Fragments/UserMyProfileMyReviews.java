 ...
 * Use the {@link UserMyProfileMyReviews#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UserMyProfileMyReviews extends Fragment implements UserReviewReportInterface {
     ...
     * @return A new instance of fragment UserMyProfileMyReviews.
     */
    // TODO: Rename and change types and number of parameters
    public static UserMyProfileMyReviews newInstance(String param1, String param2) {
        UserMyProfileMyReviews fragment = new UserMyProfileMyReviews();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_user_my_profile_my_reviews, container, false);
        seekBarUserRating1 = view.findViewById(R.id.user_my_profile_seekBar_rating_1);
        seekUserBarRating2 = view.findViewById(R.id.user_my_profile_seekBar_rating_2);
        seekBarUserRating3 = view.findViewById(R.id.user_my_profile_seekBar_rating_3);
        seekBarUserRating4 = view.findViewById(R.id.user_my_profile_seekBar_rating_4);
        seekBarUserRating5 = view.findViewById(R.id.user_my_profile_seekBar_rating_5);
        txtUserComDetRatingSecTitle = view.findViewById(R.id.txt_user_my_profile_rating_sec_title);
        txtUserTotalReviewCount = view.findViewById(R.id.txt_user_my_profile_total_reviews_count_rating_sec);
        ratingUserComDetRatingSection = view.findViewById(R.id.rating_user_my_profile_rating_sec);
        recyclerUserComDetReviews  = view.findViewById(R.id.recycler_user_my_profile_reviews);
        txtUserDetNoReviewsFoundError = view.findViewById(R.id.txt_user_my_profile_no_review_found_error);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getMyProfileReviewLive().observe(requireActivity(), userReviewModels -> {
    ...
    public void getReviewData(UserReviewModel userReviewModel) {
        FirestoreRepository.getInstance().reportUserReview(viewModel.getUserId(),userReviewModel.getUserId());
